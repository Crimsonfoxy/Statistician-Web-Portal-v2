...
<input type="text" name="dbfile" id="dbfile" placeholder="/path/to/database/file" value="<?php echo $this->get('dbfile') ?>"><br>
...
<input type="text" name="prefix" id="prefix" value="<?php echo $this->get('prefix' , 'stat_') ?>"><br>    
</fieldset>    
<br>
